...
const navItems: NavItem[] = [
  {
    ...
    name: "Movie",
    subItems: [
      { name: "Popular", path: "/", pro: false },
      { name: "Terbaru", path: "/movie/new", pro: false },
      { name: "Top Rated", path: "/movie/hits", pro: false }
  ...
  },
  {
    ...
    name: "TV Show",
    subItems: [
      { name: "Popular", path: "/tv", pro: false },
      { name: "Top Rated", path: "/tv/hits", pro: false }
